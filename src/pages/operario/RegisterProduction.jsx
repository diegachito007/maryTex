...
export default function RegisterProduction() {
  ...
  // ✅ CALCULAR PENDIENTE (cantidad restante por producir)
  ...
  return (
    <div className="p-3 md:p-6 max-w-3xl mx-auto">
      ...
      {recentRecords.length > 0 ? (
        <div className="bg-gradient-to-r from-primary-500 to-primary-600 rounded-xl p-3 md:p-4 text-white mb-4 shadow-md">
          ...
          {orders.length === 0 ? (
            ...
            orders.map(order => (
              <button
                ...
                className="w-full bg-white rounded-xl border-2 border-gray-200 p-3 md:p-4 text-left hover:border-primary-500 hover:shadow-md transition"
              >
      ...
      {step === 2 && (
        <div className="space-y-2 md:space-y-3">
          ...
          <h3 className="text-base md:text-lg font-semibold text-gray-900 flex items-center gap-2">
            <Settings className="w-4 h-4 md:w-5 md:h-5 text-primary-600" />
            Proceso
          </h3>
        ...
        <form onSubmit={handleSubmit} className="space-y-3 md:space-y-4">
          ...
          <div>
            ...
            <input
              ...
              max={pendiente}
              placeholder="Ej: 10"
              className="w-full px-3 md:px-4 py-2 md:py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 outline-none text-base md:text-lg"
              autoFocus
            />
          </div>
          ...
          <div className="flex gap-2 pt-2">
            ...
            <button
              type="submit"
              disabled={loading}
              className="flex-1 bg-primary-600 text-white px-3 md:px-4 py-2 md:py-3 rounded-lg hover:bg-primary-700 transition disabled:opacity-50 text-sm md:text-base"
            >
